...
const processSteps = [
  ["Диагностика в начале", "В начале вы проходите диагностику (отвечаете на вопросы и загружаете фото осанки, если захотите более полный разбор) и наша система подбирает для вас персонализированную программу, основанную на знаниях Дарьи, по которой вы будете заниматься.", "/program-diagnosis.png", "Диагностика осанки со специалистом"],
  ["Одна основная тренировка в неделю", "Всего на курсе — 6 персонализированных под вас тренировок для всего тела (по одной на каждую неделю). Нагрузка постепенно увеличивается: от знакомства с движением и техникой до более уверенной работы на силу, координацию и контроль осанки. Работаем 6 дней,  воскресенье – выходной.", "/program-workout.png", "Тренировка для всего тела с эластичной лентой"],
  ["Персональный комплекс на 5 минут", "Три–четыре упражнения дополняют общую программу и помогают уделить больше внимания тем звеньям цепочки, которые особенно важны в вашем случае.", "/program-personal.png", "Специалист помогает точно выполнить персональное упражнение"],
  ["Рекомендации для обычной жизни", "Вы узнаете, как чередовать нагрузку и отдых, организовать движение в течение дня и не ждать, пока боль или скованность снова заставят обратить внимание на тело.", "/program-daily-life.png", "Силуэты человека во время сидения, ходьбы и разминки"],
  ["Поддержка регулярности", "Каждый день участники отмечают выполнение упражнений. Короткий отчёт помогает не выпадать из процесса, когда стало легче или появились другие дела. В течение недели Дарья записывает короткие видео-комментарии: объясняет важные детали техники и напоминает, почему конкретный этап нужен для результата.", "/program-regularity.png", "Регулярное выполнение упражнений в течение недели"],
  ...
  return (
    <main>
      ...
      <section className="course" id="course">
        ...
        <div className="facts"><article><strong>Персонализированная</strong><p>программа ровно для ваших задач</p></article><article><strong>Умная</strong><p>диагностика в начале и конце</p></article><article><strong>15-20</strong><p>минут упражнений в день</p></article><article><strong>Нужны</strong><p>коврик и валик (дадим ссылки на озон)</p></article></div>
        ...
        <div className="course-outro"><div className="course-outro-copy"><strong>Мы не пытаемся исправить каждую зону отдельно. Мы учим тело снова работать как единую систему.</strong><Cta /></div><p className="course-warning">Курс не рассчитан на самостоятельную работу при остром состоянии, свежей травме, резком ухудшении самочувствия или симптомах, которые требуют очной медицинской оценки.</p></div>
      </section>
