...
const processSteps = [
  ["Диагностика в начале", "В начале вы проходите диагностику и наша система подбирает для вас персонализированную программу, основанную на знаниях Дарьи.", "/program-diagnosis-illustrated.webp", "Диагностика осанки со специалистом"],
  ["Одна основная тренировка в неделю", "Всего на курсе — 6 персонализированных под вас тренировок для всего тела (по одной на каждую неделю). Нагрузка постепенно увеличивается. Работаем 6 дней, воскресенье – выходной.", "/program-workout-illustrated.webp", "Тренировка для всего тела с эластичной лентой"],
  ["Персональный комплекс на 5 минут", "Три–четыре упражнения дополняют общую программу и помогают уделить больше внимания тем зонам, которые вас беспокоят", "/program-personal-illustrated.webp", "Специалист помогает точно выполнить персональное упражнение"],
  ["Поддержка регулярности", "Каждый день участники отмечают выполнение упражнений. Короткий отчёт помогает не выпадать из процесса, когда стало легче или появились другие дела.", "/program-regularity-illustrated.webp", "Регулярное выполнение упражнений в течение недели"],
  ["Три эфира с разбором техники", "Раз в две недели проходит часовой эфир с ответами на вопросы и разбором выполнения упражнений, чтобы вы делали ровно то, что подходит вашему телу.", "/program-live-review-illustrated.webp", "Онлайн-занятие с разбором техники упражнения"],
  ["Финальная диагностика", "Фиксируем результат через анкету и фотографии (не обязательно) и замечаем крылья за спиной.", "/program-final-diagnosis-illustrated.webp", "Схематичное сравнение осанки до и после курса"],
];
...
const vipFeatures = [
  "диагностика онлайн или офлайн в клинике по всем исследованиям, которые у вас есть (КТ, МРТ и другим), а также возможное назначение дополнительных исследований",
  ...
  return (
    <main>
      ...
      <section className="recognition" id="for-whom">
        <img className="recognition-person" src="/puzzled-person-watercolor-transparent.png" alt="Акварельная иллюстрация молодой женщины, которая выбирает подходящее направление занятий" width="1536" height="1024" loading="lazy" />
      ...
      <section className="process">
        ...
        <div className="process-list">{processSteps.map(([title, text, image, alt]) => <article key={title}><figure className="process-media"><img src={image} alt={alt} width="1448" height="1086" loading="lazy" /></figure><div className="process-card-copy"><h3>{title}</h3><p>{text}</p></div></article>)}</div>
      </section>
      ...
      <section className="tariffs" id="tariffs">
        ...
        <div className="tariff-grid">
          ...
          <article className="tariff-card tariff-card--vip"><p className="tariff-number">03</p><h3>VIP</h3><p>Для тех, кому нужна максимальная персонализация и еженедельная работа с Дарьей.</p><h4>Всё, что входит в тариф «Индивидуальный», а также:</h4><CheckList items={vipFeatures}/><div className="price"><div className="price-row"><strong>150 000 ₽</strong></div></div><a className="button" href={signupUrl}>Выбрать VIP-тариф <Arrow /></a></article>
        </div>
      </section>

      <section className="author">
        <div className="author-photo"><img src="/darya-author-laptop.webp" alt="Дарья Кавуненко за работой" width="853" height="1280" loading="lazy" /></div>
